...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title>Monthly Attendance - Employee Panel</title>            
             ...
             <?php include "./header.php";?>    
                ...
                <div class="page-content-wrap container">
                            <span style="padding:10px;background:#000066;color:#fff;text-align:left;font-weight:600;font-size:17px;width:100%;margin-bottom:10px;display:block;">
                                    <i class="fa fa-calendar"></i> Monthly Attendance Detail's
                                    <a href="exportAttendance.php?type=monthly&month=<?php echo date('Y-m'); ?>" style="float:right;margin-right:10px;background:#27ae60;color:#fff;padding:4px 12px;border-radius:6px;font-size:13px;text-decoration:none;">
...
<script>
   function getEmployeeData(){
        $.ajax({
                url:"getEmployeeRecordForMonthlyAttendance.php",
