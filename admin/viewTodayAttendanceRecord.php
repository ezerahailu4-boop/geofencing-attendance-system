             ...
             <?php include "./header.php";?>    
                ...
                <div class="page-content-wrap container">
                            <span style="padding:10px;background:#000066;color:#fff;text-align:left;font-weight:600;font-size:17px;width:100%;margin-bottom:10px;display:block;">
                                  <i class="fa fa-calendar"></i> Attendance Detail's
                                  <a href="exportAttendance.php?type=employee&emp_id=<?php echo intval($_GET['emp_id']); ?>" style="float:right;margin-right:10px;background:#27ae60;color:#fff;padding:4px 12px;border-radius:6px;font-size:13px;text-decoration:none;">
...
<script>
   function getEmployeeData(){
        $.ajax({
                url:"getTodayAttendance.php?emp_id=<?php echo $_GET['emp_id'];?>",
