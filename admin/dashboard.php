        ...
        <div class="page-container">
             ...
             <?php include "./header.php";?>    
                ...
                <div class="page-content-wrap">
                    ...
                    <!-- START CHARTS -->
                    <?php
                        $total = getTotalEmployee($_SESSION["admin_id"]);
                        $present = getTotlalPresentEmployee();
                        $absent = $total - $present;
                        $trend = getDailyAttendanceLast7Days();
                        $trendLabels = json_encode(array_column($trend, 'label'));
                        $trendCounts = json_encode(array_column($trend, 'count'));
                    ?>
                    <div class="row" style="margin-top:20px;">
                        <div class="col-md-4">
                            <div class="widget widget-default" style="padding:20px;">
                                <h4 style="margin-top:0;">Today's Attendance</h4>
                                <canvas id="attendanceDoughnut" height="200"></canvas>
                                <div style="text-align:center;margin-top:10px;">
                                    <span style="color:#2ecc71;">&#9632; Present: <?php echo $present; ?></span> &nbsp;
                                    <span style="color:#e74c3c;">&#9632; Absent: <?php echo $absent; ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="widget widget-default" style="padding:20px;">
                                <h4 style="margin-top:0;">Last 7 Days Attendance Trend</h4>
        ...
        <script>
            new Chart(document.getElementById('attendanceDoughnut'), {
                ...
                data: {
                    ...
                    datasets: [{
                        data: [<?php echo $present; ?>, <?php echo $absent < 0 ? 0 : $absent; ?>],
