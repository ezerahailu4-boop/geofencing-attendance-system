...
<body>
    ...
    if (isset($_POST["add"])) {
        ...
        $distance_limit = intval($_POST["distance_limit"]);
        include "./db.php";
        $check = $conn->prepare("SELECT id FROM assign_location WHERE emp_id=?");
    ...
    ?>
            ...
            $stmt = $conn->prepare("INSERT INTO assign_location(emp_id,location_id,distance_limit) VALUES(?,?,?)");
            $stmt->bind_param("iii", $emp_id, $location_id, $distance_limit);
