...
<body>
    ...
    <div class="page-container">
        ...
        <ul class="breadcrumb">
            ...
            <li class="active">AddLocation</li>
        </ul>
        <!-- END BREADCRUMB -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="lat" id="lat" class="form-control" placeholder="Location Latitude" required autofocus>
                                </div>
                            </div>
                            <!--col1 inside row---->
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="lng" id="lng" class="form-control" placeholder="Location Longitude" required>
                                </div>
                            </div>
                            <!--col3 inside row---->
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label>Address:</label>
                                    <textarea name="address" id="address" class="form-control" placeholder="Location Address" required></textarea>
                                </div>
                            </div>
                            <!--col3 inside row---->
        ...
        if (isset($_POST["add"])) {
            ...
            $longi = $conn->real_escape_string($_POST["lng"]);
            $address = $conn->real_escape_string($_POST["address"]);
            $check = $conn->prepare("SELECT id FROM master WHERE lat=? AND longi=? OR address=?");
            $check->bind_param("sss", $lat, $longi, $address);
            $check->execute();
        ...
        ?>
                ...
                $stmt = $conn->prepare("INSERT INTO master(lat,longi,address) VALUES(?,?,?)");
                $stmt->bind_param("sss", $lat, $longi, $address);
                $result = $stmt->execute();
                if ($result == TRUE) {
                ?>
                    <script>
